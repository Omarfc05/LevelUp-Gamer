  ...
  <div className="row align-items-center g-4">
    ...
    <div className="col-lg-6 text-center">
      <div className="hero-card p-4 rounded-4 shadow-lg">
        <img src="/public/img/setup.png" className="img-fluid rounded-4" alt="Set up gamer"/>
      </div>
    </div>
  </div>
</header>
...
<section className="container py-5">
  <h2 className="text-center h3 mb-4">¡Productos Destacados!</h2>
  <div className="row g-4">
    
    <div className="col-md-4">
      <a href="notfound.html">
      <div className="card h-100 text-center">
        <img src="/" className="card-img-top" alt="Catan"/>
