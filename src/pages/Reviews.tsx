        ...
        <div className="card-body">
          ...
          <form id="formResena" noValidate>
            ...
            <div className="mb-3">
              ...
              <select id="producto" className="form-select" required defaultValue="">
            ...
            <div className="mb-3">
              ...
              <textarea className="form-control" id="comentario" rows={3} placeholder="Escribe tu reseña..." required></textarea>
            </div>
            <div className="mb-3">
              <label className="form-label">Calificación</label>
              <select id="puntuacion" className="form-select" required defaultValue="">
    ...
    <div className="col-md-6">
      <div className="card bg-dark border-secondary h-100">
        <div className="card-body">
          ...
          <ul id="listaResenas" className="list-group list-group-flush text-white">
